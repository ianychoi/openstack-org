...
class MemberAutoCompleteField extends TextField
{
    ...
    {
        Requirements::javascript('openstack/code/utils/forms/js/MemberAutoCompleteField.js');
        Requirements::css('openstack/code/utils/forms/css/MemberAutoCompleteField.css');
